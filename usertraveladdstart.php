...
$country_start = $province_start = $district_start = $sub_district_start = $date_start = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $input_country_start = trim($_POST["country_start_form"]);
    $country_start = $input_country_start;

    $input_province_start = trim($_POST["province_start_form"]);
    $province_start = $input_province_start;

    $input_district_start = trim($_POST["district_start_form"]);
    $district_start = $input_district_start;

    $input_sub_district_start = trim($_POST["sub_district_start_form"]);
    $sub_district_start = $input_sub_district_start;

    date_default_timezone_set("Asia/Bangkok");
    $date_start = date("Y-m-d h:i:sa");
    ...
    if(empty($ID_Passport_err) && empty($phone_number_err)){
        ...
        $sql = "INSERT INTO travel (ID_Passport, phone_number, fname_travel, lname_travel, country_start, province_start, district_start, sub_district_start, date_start) VALUES (:ID_Passport, :phone_number, :fname_travel, :lname_travel, :country_start, :province_start, :district_start, :sub_district_start, :date_start)";
        ...
        if($stmt = $pdo->prepare($sql)){ //เตรียมคำสั่งสำหรับการดำเนินการและส่งกลับคำสั่ง object
            ...
            $stmt->bindParam(":date_start", $param_date_start);
